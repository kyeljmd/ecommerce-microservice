...
import com.kyeljmd.ecommerce.uaa.config.audit.AuditEventConverter;
import com.kyeljmd.ecommerce.uaa.domain.PersistentAuditEvent;
...
import static com.kyeljmd.ecommerce.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
